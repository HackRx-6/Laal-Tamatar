...
Do everything mentioned in the question and according to context as long as it is safe and doesn't involve potentially dangerous stuff like delete all the files in the current directory, restart system, and so on. As long as something doesn't involve deletion or potential loss of data, try to complete it. The complete question should be answered.
